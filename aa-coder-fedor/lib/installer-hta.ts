  ...
  <div class="slides">
    ...
    <div class="slide s"><div class="shade"></div><div class="rail"></div>
      ...
      <div class="ad"><div class="kicker">Оплата</div>
        <h2>ЮMoney и крипта</h2><p>Платите через ЮMoney — зарубежная карта не нужна. Тарифы как у Grok. Крипта USDT, BTC, TON. Кодер сам проверяет, что перевод пришел.</p></div></div>
