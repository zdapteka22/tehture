...
def main() -> None:
    ...
    ok("hta has ad banners", "ad-code.jpg" in hta and "ad-free.jpg" in hta and "slides" in hta)
    ok("hta is not cards page", "Platyna" not in hta and "Fyatu" not in hta)
    ok("boot unpacks ads", "$AdFiles" in boot and "GROK_AD_ad-code.jpg" in boot)
    ok("bat has ad payloads", "-----GROK_AD_ad-code.jpg-----" in raw and "-----GROK_AD_ad-free.jpg-----" in raw)
